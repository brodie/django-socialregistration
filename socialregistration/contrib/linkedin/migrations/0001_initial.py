...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='LinkedInRequestToken',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('oauth_token', models.CharField(max_length=80)),
                ('oauth_token_secret', models.CharField(max_length=80)),
                ('profile', models.OneToOneField(related_name='request_token', to='linkedin.LinkedInProfile')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='linkedinaccesstoken',
            name='profile',
            field=models.OneToOneField(related_name='access_token', to='linkedin.LinkedInProfile'),
